<template>
  <crud-modal @click="store.toggleQuoteAddedModal(false)" :showModal="store.showQuoteAddedModal">
    <template v-slot:header>
      ...
      <div @click="store.toggleQuoteAddedModal(false)" class="absolute right-10 top-7">
        <CloseIcon /></div
    ></template>
